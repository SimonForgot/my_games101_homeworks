                          ...
                          const Vector3f& dir, float& tnear, float& u, float& v)
{
    ...
    auto s1_dot_e1=dotProduct(s1,e1),s2_dot_e2=dotProduct(s2,e2),
    s1_dot_s=dotProduct(s1,s),s2_dot_d=dotProduct(s2,dir);

    if(s1_dot_e1==0)
    return false;

    tnear=s2_dot_e2/s1_dot_e1;
    u=s1_dot_s/s1_dot_e1;
    v=s2_dot_d/s1_dot_e1;
